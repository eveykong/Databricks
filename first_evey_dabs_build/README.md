# first_evey_dabs_build

The 'first_evey_dabs_build' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] first_evey_dabs_build_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/first_evey_dabs_build.job.yml). The schedule
